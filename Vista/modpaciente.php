...
<?php
  ...
  $consulta="SELECT * FROM pacientes WHERE PacIdentificacion='$idpacientes'";
...
<form name="modificarpacientes" action="../Controlador/pacientemod.php" method="POST">

                   <input name="id" type="hidden" value="<?php echo $idpacientes; ?>">
                   <label>Identificacion:</label> <input class="form-control"  type="text" name="identificacion" value="<?php echo $data['PacIdentificacion'];?>"><br>
                   <label>Nombres:</label> <input class="form-control"  type="text" name="nombres" value="<?php echo $data['PacNombres'];?>"><br>
                   <label>Apellidos:</label> <input class="form-control" type="text" name="apellidos" value="<?php echo $data['PacApellidos'];?>"><br>
                     <label>Fecha de Nacimiento:</label> <input class="form-control" type="date" name="fechanacimiento" value="<?php echo $data['PacFechaNacimiento'];?>"><br>
