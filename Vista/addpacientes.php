...
<body>
  ...
  <div class="container">
	...
	<br>
           ...
           <form name="addpacientes" action="../Controlador/pacientesadd.php" method="POST">

                   
                             <label>Identificacion:</label> <input class="form-control" type="text" name="identificacion"><br>
                             <label>Nombres:</label> <input class="form-control" type="text" name="nombres"><br>
                        <label>Apellidos:</label> <input class="form-control" type="text" name="apellidos"><br>
                        <label>Fecha de Nacimiento:</label> <input class="form-control" type="date" name="fechanacimiento"><br>
