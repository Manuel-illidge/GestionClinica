...
<?php
  ...
  $consulta="UPDATE medicos SET MedIdentificacion='$cc',MedNombres='$nombres',MedApellidos='$apellidos' WHERE MedIdentificacion='$idmedico'";
...
<body>
  ...
  <div class="container">
	...
	<h1 style="color: green;">Medico Modificado</h1>
