...
<?php
  ...
  //include es llamar a un archivo
  //require es obligatorio que exista el archivo

   require('conexion.php');

   $ccmedicoadd=$_POST['identificacion'];
   $nombresadd=$_POST['nombres'];
   $apellidosadd=$_POST['apellidos'];

   $consulta="INSERT INTO medicos(MedIdentificacion,MedNombres,MedApellidos) VALUES('$ccmedicoadd','$nombresadd','$apellidosadd')";
...
<body>
  ...
  <div class="container">
	...
	<center>
		<h1 style="color: green;">Medico Agregado</h1>
		<h3><a href="../Vista/vermedico.php">Regresar</a></h3>
	</center>
