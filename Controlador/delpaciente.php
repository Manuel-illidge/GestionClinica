...
<?php 
  ...
  $consulta="DELETE FROM pacientes WHERE PacIdentificacion='$idpaciente'";
...
<body>
  ...
  <div class="container">
	...
	<h1 style="color: green;">Paciente Eliminado</h1>
	<h2><a href="../Vista/verpacientes.php">Regresar</a></h2>
