...
<?php
  ...
  $consulta="UPDATE pacientes SET PacIdentificacion='$cc',PacNombres='$nombres',PacApellidos='$apellidos' PacSexo='$sexopaciente' WHERE PacIdentificacion='$idpacientes'";
...
<body>
  ...
  <h1 style="color: green;">Paciente Modificado</h1>
